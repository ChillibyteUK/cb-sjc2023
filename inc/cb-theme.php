...
function widgets_init()
{
    // register_sidebar(
    //     array(
    //         'name'          => __('Footer Col 1', 'cb-sjc2023'),
    //         'id'            => 'footer-1',
    //         'description'   => __('Footer Col 1', 'cb-sjc2023'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-sjc2023'),
        'footer_menu1' => __('Footer Menu 1', 'cb-sjc2023'),
        'footer_menu2' => __('Footer Menu 2', 'cb-sjc2023'),
    ));
